...
require (
	...
	github.com/devopsfaith/krakend-cobra/v2 v2.0.0
	...
	github.com/kivra/krakend-correlationid v0.0.0-20221024071953-ae5d0668f7dc
...
require (
	...
	github.com/Azure/azure-service-bus-go v0.10.7 // indirect
